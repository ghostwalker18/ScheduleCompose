...
import scheduledesktop2.composeapp.generated.resources.main_settings_descr
import scheduledesktop2.composeapp.generated.resources.settings

/**
 * Эта функция отображает список с дополнительными пунктами меню
    ...
    Box(
        ...
        DropdownMenu(
            ...
            DropdownMenuItem(
                ...
                onClick = { navigator.goSettingsActivity() }
            )
            DropdownMenuItem(
                text = {
                    Row(
                ...
                onClick = { navigator.goInfoScreen() }
            )
        }
    }
}